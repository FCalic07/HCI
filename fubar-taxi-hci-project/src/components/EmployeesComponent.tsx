...
const EmployeesComponent: React.FC = () => {
  ...
  const getStateLabel = (state: number) => {
    switch (state) {
      ...
      case 1:
        return { label: "Driving", color: "bg-red-100 text-red-800" };
      case 2:
        return { label: "On brake", color: "bg-yellow-100 text-yellow-800" };
      default:
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            ...
            <span className="ml-4 text-sm text-green-600">● Live Updates</span>
          </p>
        </div>

        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8 justify-between items-stretch">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 sm:flex">
                  Total Drivers
                </p>
              ...
              >
                <div className="p-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span
                      className={`px-2 py-1 text-xs font-semibold rounded-full ${stateInfo.color}`}
                    >
                      {stateInfo.label}
                    </span>
                  </div>
        ...
        {drivers.length === 0 && !loading && (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">
              No driver data found in the database.
            </p>
          </div>
        )}
      </div>
