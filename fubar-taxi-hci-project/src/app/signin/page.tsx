...
const LoginForm: React.FC = () => {
  ...
  console.log("error prije svega je " + error);
  //Ovo se poziva svaki put kada utipkam novi karakter, znači novi render što je neoptimizirano
  //također zna izbacit true pa izbaci error msg prije uspješne prijave
